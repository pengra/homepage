...
class Command(BaseCommand):
    help = "Blacklist all results returned by this query to never show up"
    ...
    def search(self, query):
        ...
        for result in results:
            ...
            result.blacklist = (
                not (result.wiki or result.arxiv or result.uw or result.edu or result.sx)
            )
            result.save()
